...
public class FileGenerationsResource extends TracingResource
{
    ...
    @Operation(summary = GET_VERSION_FILE_GENERATION)
    ...
    @Operation(summary = GET_VERSION_FILE_GENERATION_BY_ELEMENT_PATH)
    @Produces(MediaType.APPLICATION_JSON)
    ...
    @Operation(summary = GET_VERSION_FILE_GENERATION_BY_FILEPATH)
    @Produces(MediaType.APPLICATION_JSON)
    public Response getFileGenerationsByFilePath(@PathParam("groupId") String groupId,
                                                             @PathParam("artifactId") String artifactId,
                                                             @PathParam("versionId") @Parameter(description = VersionValidator.VALID_VERSION_ID_TXT) String versionId, @PathParam("filePath") String filePath, @Context Request request)
    {
    ...
    @Operation(summary = GET_VERSION_FILE_GENERATION_CONTENT)
    ...
    @Operation(summary = ResourceLoggingAndTracing.GET_VERSION_FILE_GENERATION_BY_TYPE)
    @Produces(MediaType.APPLICATION_JSON)
    public Response getFileGenerations(@PathParam("groupId") String groupId, @PathParam("artifactId") String artifactId, @PathParam("versionId") @Parameter(description = "a valid version string: x.y.z, master-SNAPSHOT") String versionId, @PathParam("type") String type, @Context Request request)
    {
