...
public class TestPureModelContextService extends TestBaseServices
{
    ...
    public void testErrorThrownWhenNoProjectVersionFound()
    {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> getPureModelContextDataAsString("test.legend", "blank-prod", BRANCH_SNAPSHOT("master"), CLIENT_VERSION, false), "project version not found for test.legend-blank-prod-master-SNAPSHOT");
    }
    ...
    {
        Assertions.assertThrows(IllegalArgumentException.class, () -> getPureModelContextDataAsString("examples.metadata","test", "lastest", "dummy_version", false));
    }
}
